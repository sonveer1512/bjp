...
class Nagarpalika extends CI_Controller {
...
parent::__construct();
	...
	public function index()
	{
		...
		if ($this->session->userdata('pmsadmin') == true) {
			...
			return $this->load->view('admin/nagarpalika/list',$data); 
		} else {
	...
	public function addnagarpalika()
	{
	...
	public function delete($id)
{
    ...
    $this->Subadmin_model->deletesubadminnagar($id);
    redirect('nagarpalika');
}

public function nagarpalikaedit()
{
	
		$id =  $this->input->post('id');
		$data['content'] = $this->Subadmin_model->nagarpalikaedit($id);

        
		$this->load->view('admin/nagarpalika/edit',$data);

}

public function updatenagarpalika()
{
