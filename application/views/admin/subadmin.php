...
<div class="main-content">
                        ...
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <?php if ($this->rbac->hasPrivilege('regional', 'can_add')) { ?>
                                    <button type="button" data-toggle="tooltip" data-placement="bottom" title="Add New Subadmin" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModalgrid"><i class="ri-user-add-line"></i></button>
                                <?php } ?>
                            </div>
                        </div><!-- end card header -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalgridLabel">Add New Subadmin </h5>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="delete<?php echo $row->admin_user_id; ?>">
                                                    ...
                                                    ?>
                                                        <td>
                                                            <i class="ri-checkbox-circle-line" data-toggle="tooltip" data-placement="bottom" title="Disable Your Account" name="archive" class="remove" type="submit" onclick="disableaccount('<?php echo $row->admin_user_id ?>','<?=$row->admin_email?>')" data-toggle="tooltip" data-placement="bottom" style="color: green;"></i>
                                                        </td>
                                                    <?php } else { ?>
                                                        <td>
                                                            <i class="ri-alert-line" data-toggle="tooltip" data-placement="bottom" title="Enable Your Account" name="archive" class="remove" type="submit" onclick="enableaccount('<?php echo $row->admin_user_id ?>','<?=$row->admin_email?>')" data-toggle="tooltip" data-placement="bottom" style="color: red;"></i>
                                                        </td>
                                                    <?php } ?>
    ...
    <div class="modal fade" id="editsubadmin" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Edit Subadmin</h5>
...
<script type="text/javascript">
    function archiveFunction(admin_user_id,admin_email) {
        ...
        swal({
                title: "Are you sure?",
                text: "Delete Subadmin Record "+admin_email,
                type: "warning",
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "<?= base_url() ?>Subadmin/deletesubadmin/admin_user_id",
                        type: "post",
                        data: {
...
<script>
    ...
    $(document).on('submit', '#addSubadmin', function(ev) {
        ...
        if (error == false) {
            $.ajax({
                url: "<?= base_url('subadmin/addsubadmin'); ?>",
                type: 'post',
                data: formData,
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.editmodel').click(function() {
            ...
            $.ajax({
                url: "<?= base_url('Subadmin/subadminedit'); ?>",
                type: "post",
                data: {
                    id: userid
                },
