...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 07:50:26 GMT -->
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index-2.html" class="d-inline-block auth-logo">
                                    <img src="<?= base_url() ?>/assets/logo.png" alt="" height="100">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Axpert Exhibits PVT Limited Company</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Bjp.</p>
                                </div>
                                <div class="p-2 mt-4">
                                            ...
                                            <div>
                                                ...
                                                if ($this->session->flashdata('denied')) { ?>
                                                    <div class="alert alert-danger mb-xl-0" role="alert">
                                                        <strong> <?= $this->session->flashdata('denied'); ?> </strong>
                                                    </div>
                                                <?php } ?>
                                                <?php
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 07:50:27 GMT -->
