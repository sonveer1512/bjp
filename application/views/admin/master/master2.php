                            ...
                            <div class="card">
                             ...
                             <?php   $level1 = $this->Subadmin_model->list_common_where3('master_hierarchy', 'parent_id', '0'); ?>
                                    ...
                                    <div class="list-group col nested-list nested-sortable-handle">
                                        <?php if(!empty($level1)){ foreach($level1 as $val1){ ?>
                                        <div class="list-group-item nested-1"><i class="ri-drag-move-fill align-bottom handle"></i><?=$val1['name']?>
                                            ...
                                            <?php   $level2 = $this->Subadmin_model->list_common_where3('master_hierarchy', 'parent_id', $val1['id']); ?>
                                            <?php if(!empty($level2)){ foreach($level2 as $val2){ ?>
                                                <div class="list-group-item nested-2"><i class="ri-drag-move-fill align-bottom handle"></i><?=$val2['name']?>
                                                    <div class="list-group nested-list nested-sortable-handle">
