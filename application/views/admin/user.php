                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0 showdata">
                                ...
                                <span type="button" data-toggle="tooltip" data-placement="bottom" title="Upload Data"
                                    class="badge align-middle ms-1" data-bs-toggle="modal"
                                    style="border: 2px solid #405189; color:#405189;"
                                    data-bs-target="#staticBackdrop"><i class="ri-upload-cloud-line"
                                        style="font-size:10px"></i></span>
                                <span type="button" class="badge align-middle ms-1" data-placement="bottom"
                                    title="Download Excel" data-id="fakedata"
                                    style="border: 2px solid #ffbe0b; color:#ffbe0b;"><a
                                        href="<?=base_url()?>userdata/exportdata"><i
                                            class="ri-download-cloud-2-line"></i></a> </span>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-body text-center p-5">
                                        <lord-icon src="https://cdn.lordicon.com/qduilmpq.json" trigger="loop"
                                            ...
                                            <a href="<?php echo base_url(); ?>Sample/follow lead sample.xlsx" download>
                                                <button type="button" data-toggle="tooltip" data-placement="bottom"
                                                    ...
                                                    class="btn btn-primary waves-effect waves-light"><i
                                                        class="ri-download-cloud-2-line"></i></button></a><br><br>
                                            <form method="POST" action="<?php base_url() ?>userdata/importexcel"
                                                enctype="multipart/form-data">
                                                <div class="col-md-12">
                                                    <input type="file" class="form-control" id="uploadFile"
                                                        name="uploadFile" placeholder="Select Your File" required
                                                        accept=".xls, .xlsx">
                                                </div><br>
                                                <div class="hstack gap-2 justify-content-center">
                                                    ...
                                                    <input type="submit" name="fileuploadsubmit" class="btn btn-primary"
                                                        value="Upload">
                                                </div>
                                            </form>
                        ...
                        <div class="modal fade" id="followdata" data-bs-backdrop="static" data-bs-keyboard="false"
                            tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body text-center p-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <form method="POST" action="<?php base_url() ?>followleaddata"
                                                enctype="multipart/form-data">
                                                <br><br>
                                                <table
                                        ...
                                        <tbody id="productdetailsdiv" class="filterdata">
                                            ...
                                            if ($useritem) {
                                                foreach ($useritem as $value) { 
                                                    // print_r($value); exit();
                                            ?>
                                            <tr <?php if($value['datastatus']=='active' ){?>
                                                style="background:#F97D09;color:white;"
                                                <?php } if($value['datastatus'] =='fakedata') {?>
                                                style="background:red;color:white;"
                                                <?php }  if($value['datastatus'] =='inactive'){?>
                                                style="background:#278D27;color:white;"
                                                <?php } ?>>
                                                <th scope="row">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="checkAll"
                                                            id="flexSwitchCheckChecked" value="<?=$value['id']?>">
                                                    </div>
                                                </th>
                                                <td>
                                                    <?php if(empty($value['ex_man'])){ ?>
                                                    <i class="ri-add-circle-line fs-16 p-2 bg-soft-primary text-primary rounded-circle align-middle me-2"
                                                        data-bs-toggle="modal" data-bs-target="#addexmembers"
                                                        onclick="add_ex_deginity(<?=$value['id']?>)"></i>
                                                    <?php } else{?>
                                                    <img src="<?=base_url()?>assets/images/14.png" alt=""
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="<?=$value['ex_man']?>"
                                                        class="avatar-xs rounded-circle me-2 shadow"
                                                        data-bs-toggle="modal" data-bs-target="#editexmembers"
                                                        onclick="edit_ex_deginity(<?=$value['id']?>)">
                                                    <?php } ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<?= base_url() ?>editbjp/<?= $value['id'] ?>"><i
                                                            class="ri-edit-box-line " style="color: blue;"></i></a>
                                                </td>
                                                <?php if ($value['flag'] == 0) {
                                                        ?>
                                                <td>
                                                    <i class="ri-checkbox-circle-line" data-toggle="tooltip"
                                                        data-placement="bottom" title="Disable Your Account"
                                                        name="archive" class="remove" type="submit"
                                                        onclick="disableaccount1(<?= $value['id'] ?>)"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        style="color: green;"></i>
                                                </td>
                                                <?php } else { ?>
                                                <td>
                                                    <i class="ri-alert-line" data-toggle="tooltip"
                                                        data-placement="bottom" title="Enable Your Account"
                                                        name="archive" class="remove" type="submit"
                                                        onclick="enableaccount(<?= $value['id'] ?>)"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        style="color: red;"></i>
                                                </td>
                                                <?php } ?>
...
<script>
  ...
  function is_panchayat_data(id) {
        ...
        if (id != '') {
            $.ajax({
                url: '<?= base_url() ?>filter/is_panchayat_filter_data_imported/' + id,
    ...
    function gram_panchayat_data(id) {
        ...
        if (id != '') {
            ...
            $.ajax({
                url: '<?= base_url() ?>filter/gram_panchayat_filter_data_imported/' + id,
                type: 'post',
                data: {
    ...
    function gram_data(id) {
        ...
        if (id != '') {
            ...
            $.ajax({
                url: '<?= base_url() ?>filter/gram_data_imported/' + id,
                type: 'post',
                data: {
                    is_panchayat_id: is_panchayat_id,
    ...
    function mohalla_data(id) {
        ...
        if (id != '') {
            ...
            var gram = $('#gram').val();
            $.ajax({
                url: '<?= base_url() ?>filter/mohalla_data_imported/' + id,
                type: 'post',
                data: {
                    is_panchayat_id: is_panchayat_id,
                    gram_panchayat: gram_panchayat,
