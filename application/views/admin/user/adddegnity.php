                            ...
                            <div class="col-xxl-6">
                                <div>
                                    ...
                                    <input type="text" value="<?php echo $item[0]['name'];?>" class="form-control" name="name" id="name" placeholder="Enter Name" readonly>
 					...
 					<div class="col-xxl-6">
                                <div>
                                    ...
                                    <input type="text" value="<?php echo $item[0]['f_name'];?>" class="form-control" name="f_name" id="f_name" placeholder="Enter Fathre's Name" readonly>
                                    <div class="error" id="subnameError"></div>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-xxl-6">
                                ...
                                <div>
                                    ...
                                    <textarea type="text"  class="form-control" name="remark" id="remark" placeholder="Enter Remark"></textarea>
                                </div>
                            </div>
                            <!--end col-->
                        ...
                        <input type="hidden" value="<?php echo $item[0]['id'];?>" name="id">
</div>
                        <!--end row-->
